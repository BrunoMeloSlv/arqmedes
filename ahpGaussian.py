...
def show():
    # Carrega os dados
    dados = pd.read_csv('https://raw.githubusercontent.com/BrunoMeloSlv/arqmedes/refs/heads/main/data_export_20241014.csv', sep = ',')
    #dados = pd.read_csv("data_export_20241014.csv", sep=",")
    max = '2024-06-01'
    ...
    st.title('Análise AHP Gaussiano')
    ...
    with st.expander('Dados após aplicação dos filtros',0):
